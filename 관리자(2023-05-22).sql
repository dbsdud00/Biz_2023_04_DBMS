...
-- 2. DB에 연결하여 실습(사용)할 일반사용자 계정을 생성하기
CREATE USER C##myuser IDENTIFIED BY 12341234
DEFAULT TABLESPACE myDB;


-- 3. 생성한 사용자 계정에 권한(ROLL) 부여하기

-- login 할 수 있는 권한 부여(접속만 할 수 있음)
...
-- 실습의 편리성을 위하여 SYSDBA보다 한단계 낮은 일반 DBA권한을 부여
