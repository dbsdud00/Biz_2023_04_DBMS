...
-- Oracle 은 데이터를 보관하기 위하여 데이터 저장공간을 먼저 설정해야 한다.
-- 물리적 저장공간을 Table space 라고 한다.

-- addrDB 라는 이름의 저장소 만들겠다
...
-- System 을 통해 DB 데이터에 접근할 때는 TABLESPACE 를 통하지 않는다.
...
/*
addr 이라는 사용자 ID 를 등록하고 비밀번호는 12341234 로 한다.
...
/*
세로 생성한 사용자에게 DB 접근(CRUD) 할 수 있는 권한 부여
...
System 에 직접 접근하는 것은 금지하고, 그외 권한은 모두 부여한다.
*/
